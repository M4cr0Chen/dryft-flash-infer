...
try:
    ...
    from .reference import (
        add_rms_norm as add_rms_norm_separate,
        add_rms_norm_partials as add_rms_norm_partials_separate,
    )
    ...
    from .norm import (
        add_rms_norm, add_rms_norm_partials, rms_norm,
    ...
    from .swiglu import swiglu, swiglu_partials
