"""Experimental native INT8 MMA, with optional activation residual correction."""
import functools
import torch
import triton
...
def matmul(x, prepared, config=(4, 1), components=1, mode=0):
    return matmul_quantized(quantize_activation(x, components), prepared, config, components, mode)
